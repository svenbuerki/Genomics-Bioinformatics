...
Once you have gathered all required information (i.e., IP address and username) and installed [Putty](#Putty) if you have a Windows OS, please open a `Terminal` or command prompt window and type the following command to remotely access your account using the ssh protocol (see Figure \@ref(fig:ssh)):
