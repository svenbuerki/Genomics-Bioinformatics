...
## Tests conducted during this course and grading
...
Exams are summing to a total of **300 points** and grading will follow the scale presented in Table \@ref(tab:mygrade). Consult the [Timetable](timetable) for information on dates when assignments are due.
