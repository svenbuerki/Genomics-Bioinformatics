...
The goal of this course is to provide students with the theoretical and applied knowledge in genomics and bioinformatics to sequence, assemble and annotate eukaryote genomes [@Saitou2013], especially for non-model organisms [@Russell2017] (see Figure \@ref(fig:flowchart)). To provide an authentic research experience, we will be using examples from the instructor's research on sagebrush (*Artemisia tridentata*; Asteraceae) genomics [e.g., @Melton2021; @Melton2022].
