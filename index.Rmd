...
A comprehensive list of references used in this course is provided [here](References.html). In addition, there are numerous online resources dedicated to genomic and transcriptomic data. A selection is provided below:
...
Finally, the instructor has assembled a [Lexicon](Lexicon.html) containing definitions of key concepts used in this course. If you encounter a term that is **not included in the Lexicon**, please contact the instructor to have it added.
...
To further develop expertise in genomics and bioinformatics, students will produce three [mini-reports](Mini_reports.html) that align with the course’s core learning outcomes:  
...
Students can access `bash` and `R` scripts associated with this lab report [here](Mining_draft_genome.html).
...
These two non-mandatory assignments have **strict deadlines** (see [Timetable](#timetable)). **No extensions will be granted**, and any work submitted after the deadline **will not be considered**. Students who do not submit by the deadline will be deemed not interested in earning the extra credits.  
