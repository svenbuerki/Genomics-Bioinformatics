...
Before delving into the code, start by creating an `.R` file in `RStudio` and save it at the root of your project (`DNA_barcoding/`) with the following name `01_PART2.R`.
