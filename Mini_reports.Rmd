...
## Introduction of model species {#vanilla}
...
## DNA barcodes generated for the vanilla project {#vanbarcode}
...
## Hypothesis and methodology {#sciprocess}
...
Our **analyses** will be done in 4 steps:
  1. PCR and Sanger sequencing of ITS barcodes for target individuals (= raw data are provided on Google Drive).
  2. Assembly of reference ITS data available on GenBank using R.
  3. BLAST and RAxML Maximum Likelihood phylogenetic analysis (including bootstrap analysis to assess node supports).
  4. Produce figures using R.
  
Finally, we will intersect evidence from all our analyses (especially phylogenetic clustering combined with node supports and taxonomy of ITS sequences from GenBank) to infer species identity of our target individuals. Please see section \@ref(report) for more details our the formatting of the report.
