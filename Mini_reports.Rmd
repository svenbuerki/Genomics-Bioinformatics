...
This mini-report is organized into the following sections to guide you step by step through both the scientific concepts and the practical analyses:

- [**Group activity**](#grpactivity_vanilla): You will collaboratively read and discuss the publication that forms the foundation of Mini-Report 3. This activity helps you understand the biological questions, study design, and types of DNA evidence used in species research.  

- [**Theoretical background**](#IntroMR3): This section introduces the key concepts you need for the report, including scientific questions, hypotheses (and predictions), methodology, data availability, and report structure and formatting. Use this section as a reference while working on your assignment.  

- **Bioinformatics:** In this section, you will perform the bioinformatics analyses used to replicate parts of the study at the core of Mini-Report 3. These hands-on steps will help you connect theory to real data.
    - [**Part 1**](#part1): Process and clean ITS DNA sequence electropherograms and develop a species working hypothesis.  
    - [**Part 2**](#part2): Retrieve DNA sequences and prepare datasets for analysis.  
    - [**Part 3**](#part3): Perform multiple sequence alignment and phylogenetic inference.

- [**Writing report**](#report): This section provides detailed guidelines to help you write and organize your individual mini-report.
