...
# Mini-report 3 -- Identifying species based on DNA barcoding and phylogenetic inference {#mini3}
...
DNA barcoding has a wide range of applications from biodiversity surveys [e.g. @telfer2015biodiversity], illegal trade of wildlife [e.g. @gonccalves2015dna] to food security [e.g. @quinto2016dna]. The DNA barcoding approach has been recently reviewed by @deSalle2019. 
...
1. To what species of vanilla do individuals presented in Figure \@ref(fig:van) belong to?
...
4. Analyses are done in 4 steps:
    - PCR and Sanger sequencing of ITS barcodes for target individuals (= raw data are provided on Google Drive).
    - Assembly of reference ITS data available on GenBank using R.
    - BLAST and RAxML Maximum Likelihood phylogenetic analysis (including bootstrap analysis to assess node supports).
    - Produce figures using R.
5. Intersect evidence from analyses (especially phylogenetic clustering combined with node supports and taxonomy of ITS sequences from GenBank) to infer species identity of our target individuals. Use criterion of monophyly to help circumscribe species.
...
**Upload your reports on the shared Google drive by the 16th of March before 5 PM MT.** 
