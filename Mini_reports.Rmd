...
6. Visualize and produce phylogenetic tree figures using R packages.
...
### Summary of DNA barcode generation for project {#vanbarcode}
...
For the purpose of this mini-report, **we will be focusing on four samples of vanilla (see Figure \@ref(fig:van)) and their associated ITS sequence data**.
...
Throughout this project, we will be referring to these vanilla samples as follows (see Figure \@ref(fig:van)):
