...
To develop a comprehensive understanding of molecular biology databases and their role in genome annotation, students will produce **individual mini-reports** on one of the following major database categories:
...
Time is allocated in class on week 4, to work on this assignment. Reports are due on **February 18, 2026**, and must be uploaded to the shared [Google Drive](https://drive.google.com/drive/folders/1BFZFJeR8tW8N7QLfngqIVbjqEkDuIyWj?usp=sharing) in the `Mini_Report_2` folder.
...
The instructor provides the following summaries to help you begin. Use these, along with external literature and web resources, to build your report. All claims must be supported with **proper citations**, following the guidelines used in Mini-Report 1.
...
|--------|--------|-------------|
| **Scientific Accuracy & Depth** | 8 | Demonstrates correct understanding of the database type and its role in genome annotation |
| **Coverage of Assigned Topics** | 6 | Addresses all required components listed in the report structure |
| **Critical Analysis** | 5 | Evaluates strengths, limitations, and practical uses of the database |
| **Clarity & Organization** | 4 | Well-structured, logical flow, and clear writing |
| **References & Citation Quality** | 2 | Appropriate use of peer-reviewed and authoritative sources |
...
### How Many Species Ere There On Earth?
