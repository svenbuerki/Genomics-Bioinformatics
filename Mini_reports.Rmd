...
The following learning outcomes will be covered as part of this Mini-Report:

- Interpret how DNA sequence data are used in published studies to investigate biological variation, species boundaries, and evolutionary relationships (based on the group activity discussion).
- Learn the terminology associated with DNA barcoding and phylogenetic analyses. Key definitions are available in the [Lexicon](Lexicon.html).
- Process and clean DNA sequence electropherograms generated using the [Sanger sequencing approach](https://dnalc.cshl.edu/resources/animations/cycseq.html) (from PCR amplifications). 
- Validate DNA sequences and develop a **species working hypothesis** by conducting BLAST similarity searches. These analyses will be based on DNA sequences deposited in [GenBank](https://www.ncbi.nlm.nih.gov/genbank/) [@GenBankP].  
- Query GenBank and download DNA sequences for phylogenetic analyses using `R` [@R] packages.  
- Produce multiple DNA sequence alignments (including both your target DNA sequences and those retrieved from GenBank). This will be done using `MUSCLE` [@edgar2004muscle], implemented in `MEGA` [@kumar2018mega].  
- Perform phylogenetic inference using the **Maximum Likelihood** criterion as implemented in RAxML [@Stamatakis2014]. This phylogenetic framework will be used to test and refine species working hypotheses under the phylogenetic species concept [@wheeler1999phylogenetic].  
- Visualize and interpret phylogenetic results using `R` [@R] packages.  
...
- [**Group activity**](#grpactivity_vanilla): Collaborative reading and discussion of the publication that forms the basis of Mini-Report 3.  
- [**Theoretical background**](#IntroMR3): Overview of key theoretical concepts, scientific questions, hypotheses (including predictions), methodology, data availability, and report structure and formatting.  
- [**Part 1**](#part1): Process and clean ITS DNA sequence electropherograms and infer a species working hypothesis.  
...
Ellestad *et al.* (2022). **Uncovering haplotype diversity in cultivated Mexican *Vanilla* species.** *American Journal of Botany*.  
...
Students evaluate how DNA sequence data are used to interpret biological variation and species boundaries, preparing them for **Mini-Report 3** on DNA-based species identification and phylogenetic inference.

---

### Activity Overview

In this **1 hour and 20 minutes** in-class group activity, students work in groups of **3–4** to investigate how researchers use DNA sequence data to understand biological diversity.

The **goals** are to:

- Identify the study’s research aims and guiding questions  
- Understand how sequencing data are used to interpret biological variation  
- Connect DNA barcoding and phylogenetics to species delimitation  
- Develop evidence-based explanations for observed phenotypic and genetic patterns  
...
- [Theoretical background](#IntroMR3) section, which includes additional resources on topics relevant to this group activity.
...
3. Based on the introduction, what do you think the researchers are trying to determine about this variation?

➡️ **Outcome of this section:**  
Groups propose **one or more possible explanations** for why individuals or populations might differ.

---

### Part 2 — How Do the Authors Use DNA Data? <span style="color:gray;">(25 minutes)</span>

Groups now examine the **methods and results**.

Discuss:

- Which DNA regions (markers) are sequenced?  
- What sequencing approach is used?  
- How do the authors analyze the data (e.g., alignments, haplotypes, phylogenetic trees)?  
- What patterns do they look for in the genetic data?
...
*Do not worry about perfect terminology yet — focus on reasoning from the data.*

---

### Part 3 — From DNA Patterns to Biological Meaning <span style="color:gray;">(25 minutes)</span>

Groups interpret the findings.
...
➡️ At this stage, groups should be able to articulate **two contrasting biological interpretations** that could explain the observed variation.
...
- **One proposed explanation** for the observed variation, supported by evidence from the paper  
- Select **one or two group members** to speak during the discussion

Encourage groups to reference specific figures or results.
...
- How this study illustrates the role of DNA barcoding and phylogenetics in species delimitation  

The discussion emphasizes how scientists move from **genetic patterns → evolutionary interpretation**, a key skill for Mini-Report 3.
...
##### Code to produce your first phylogenetic tree
