...
Time will be allocated in class on the 20th of January 2023 to allow students to work on their assignments. Reports are due on **the 3rd of February 2023** and should be uploaded on the shared [Google Drive](https://drive.google.com/drive/folders/1BFZFJeR8tW8N7QLfngqIVbjqEkDuIyWj?usp=sharing) in the `Mini_Report_1` folder.
...
The **references section** should contain full citations of all references cited in the text. Each reference cited in the References section should be clearly cited in the text to support transparency in your work and overall reproducible science. 
...
The instructor has provided `pdf` documents devoted to each sequencing platform below to support students in starting their assignments. Please also see @Marx2023 for more information on long-read sequencing.
