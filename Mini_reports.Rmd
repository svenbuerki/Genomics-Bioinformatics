...
6. Extract subtree containing our vanilla samples and plot tree (this time using the radial plotting mode; see Figure \@ref(fig:Vantreesub)). To visualize your vanilla samples we will plot a red circle next to their tips. 
...
#Find which tips are your samples and replace color by red 
tipcolVan[grep("-ITSp4", VanITS$tip.label)] <- "red"
