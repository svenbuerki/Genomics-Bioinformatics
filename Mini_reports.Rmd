...
8. Save the file in `04_Data_analyses/FASTA/` and adjust file name as follows: `_GenBank_seq_msa_output.fas`. This procedure is shown in Figure \@ref(fig:musclefile).
