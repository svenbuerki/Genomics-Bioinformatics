...
Time will be allocated in class on the 3rd of February 2023 to allow students to work on their assignments. Reports are due on **the 17th of February 2023** and should be uploaded on the shared [Google Drive](https://drive.google.com/drive/folders/1BFZFJeR8tW8N7QLfngqIVbjqEkDuIyWj?usp=sharing) in the `Mini_Report_2` folder.
...
- Highlight potential contributions of these databases to support the annotation of genomes.
- Provide an overview or survey of available bioinformatic tools and websites to query/access these databases and conduct analyses. 
