...
To facilitate communication, deadlines and point allocations for the assignments associated with this course are provided in Table \@ref(tab:deadlines). Please see [here](https://svenbuerki.github.io/Genomics-Bioinformatics/index.html#13_Grading_information) for more information on each assignment. All assignments should be submitted on [Google Drive](https://drive.google.com/drive/folders/1BFZFJeR8tW8N7QLfngqIVbjqEkDuIyWj?usp=sharing).
...
###~~~
knitr::kable(deadlines,  caption = "Deadlines of graded assignments for the Genomics and Bioinformatics course during the Spring semester 2024.") %>%
...
###~~~
dates <- data.frame(seq.Date(from=as.Date("2024/01/08"), to=as.Date("2024/04/29"), by="day"))
...
holiday <- seq.Date(from=as.Date("2024/03/18"), to=as.Date("2024/03/22"), by="day")
...
colnames(timetable)[5] <- "Homework/Deadlines"
#colnames(timetable)[6] <- "Teaching mode"
###~~~
#Plot timetable in doc
###~~~

knitr::kable(timetable,  caption = "Tentative timetable for the Genomics and Bioinformatics course during the Spring semester 2024.") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
