...
**This course will be mostly taught remotely; however we might have opportunities to meet in-person for computing laboratory sessions (see below).** This means that courses meet virtually via technology (here Zoom) at scheduled class meeting times (see below).
...
Details to join the Zoom meetings and find URLs to recordings are provided [here](https://docs.google.com/document/d/1y79tlH-shdh68kUuYv6A9ZGmqyj5mwB2opmGR3V6A78/edit?usp=sharing). Students will be granted access to this document prior to the start of the semester.

## Class location

We might be able to schedule in-person laboratory classes to use the Linux computers. These sessions will take place in the Science building in the computer laboratory: **SCNC149**. Further information will be provided by the instructor.
...
The aim of the journal club (taking place on weeks 4, 8 and 13) is to train students to read scientific papers related to genomic data.
Journal clubs will also provide opportunities for students to learn how to present their scientific papers on week 16.

Students are expected to have read the scientific papers before coming to class.
...
Please find below the list of papers that we will discuss in class:

-   **Week 4:** @Li2009 published a draft genome of the giant panda and screened for genes responsible for the detoxification of cyanide produced by bamboos.
-   **Week 8:** TBD. The instructor will be selecting a scientific paper and sharing it two weeks in advance.
-   **Week 13:** @Ming2015 published the draft genome of the pineapple and investigated the origin of CAM photosynthesis in this lineage.

If you are not familiar with approaches to read scientific papers, please come and seek advice.
...
-   1 individual oral paper presentation (50 points).
-   1 lab report (150 points).
-   1 lab presentation (50 points).

Exams are summing to a total of **350 points** and grading will follow the scale presented in Table \@ref(tab:mygrade).
...
- Sequencing technologies (25 points; this task is related to Chapter 2).
- Molecular biology databases (25 points; this task is related to Chapter 3).
- Use knowledge from the previous mini-reports to review plant genomes available on GenBank database (50 points). Here, we will be using `R` to mine and analyze data.
...
## Individual oral paper presentation (TOTAL: 50 points)

Each student will have to present a scientific paper on week 16 related to material presented in Chapter 8.
Time will be allocated on week 15 to select a paper and work on presentations, but the instructor strongly advise students to start this endeavor sooner.
...
Students will be working individually or in groups to produce a report associated to the following research question:
...
## Lab presentations (TOTAL: 50 points)
