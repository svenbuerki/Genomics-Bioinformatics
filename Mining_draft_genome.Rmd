...
**Disclaimer:** This procedure only works if you have a unix-based computer. If you don't have a unix-based computer, please ask instructors to transfer this file for you to your account.

```{r, echo=F, eval=F}
cp in bioinformatics folder
```
...
2. Navigate to project directory (`DraftGenomeMineR/`).
3. Create a new folder (`Output_FASTAs/`) using `mkdir` to store results of scaffold analysis.
...
We should now have ORF reports and FASTA files of translated ORFs. Let's check these outputs.
