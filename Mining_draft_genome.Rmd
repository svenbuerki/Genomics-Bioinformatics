...
2. Extract DNA and AA sequences from ORF(s) identified by protein BLAST analysis. Students will provide DNA sequence of Aquaporin gene located on scaffold and its associated protein sequence. 
...
3. Copy content of `Scaffold151535_ORFs.fa` as shwon in Figure \@ref(fig:protBLASTinput) and press `BLAST` button to send the query.
...
```
4. Inspect output of protein BLAST analysis and identified ORF(s) along scaffold coding for Aquaporin genes (see \@ref(fig:protBLASToutput)).
...
## Extract DNA and AA sequences from ORF(s) identified by protein BLAST analysis
