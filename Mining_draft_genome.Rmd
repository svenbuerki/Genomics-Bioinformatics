...
In this module, we are working on code to annotate the ORFs inferred in module 2 and assemble protein sequences. The annotation will be carried out by performing a BLAST analysis.
