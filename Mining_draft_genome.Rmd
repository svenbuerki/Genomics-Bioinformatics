...
```
4. Note that although the AQP protein sequence is not complete, the analysis still modeled it correctly and predicted that it belongs to the PIP subfamily (see Figure \@ref(fig:phyreoutput)). 
